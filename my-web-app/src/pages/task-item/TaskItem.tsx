  ...
  return (
    <div className={styles.card}>
      ...
      <div className={styles.tags}>
        <Tag style={{ backgroundColor: getStatusColor(task.status) }}>{task.status}</Tag>
        <Tag style={{ backgroundColor: getPriorityColor(task.priority) }}>{task.priority}</Tag>
      ...
      <div className={styles.actions}>
        ...
        <Button dimension="s" appearance="secondary" onClick={() => onDelete(task.id)}>
          Delete
        </Button>
